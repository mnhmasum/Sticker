...
public class NewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mnew);
		
		load = (TextView)findViewById(R.id.textFooterLebel1);
		load.setVisibility(View.GONE);
		//Top List View
		mNewListViewItem = (ListView)findViewById(R.id.list_newtab);
		...
		mNewListViewItem.setOnItemClickListener(new OnItemClickListener() {
		...
		mNewListViewItem.setOnScrollListener(new OnScrollListener() {
	...
	class loadAsyncTask extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String unused) 
		{
			load.setVisibility(View.GONE);
			if(loadcounter==0){
				mCustomTabListAdapter = new CustomTabListAdapter(NewActivity.this, TopItemList);
				mNewListViewItem.setAdapter(mCustomTabListAdapter);
				
			}else{
				
				mNewListViewItem.setSelection(pos);
				mCustomTabListAdapter = new CustomTabListAdapter(NewActivity.this, TopItemList);
