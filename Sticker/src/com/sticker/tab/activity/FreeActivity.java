...
public class FreeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Top List View
		mFreeListViewItem = (ListView)findViewById(R.id.list_freetab);
		...
		mFreeListViewItem.setOnItemClickListener(new OnItemClickListener() {
		...
		mFreeListViewItem.setOnScrollListener(new OnScrollListener() {
	        ...
	        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
	            ...
	            if(lastItem == totalItemCount){                 
	            	...
	            	pos = firstVisibleItem + 2;
	            	 ...
	            	 Log.i("CHECK ITEM ON ","" + totalItemCount + "=" + mFreeListViewItem.getLastVisiblePosition());
	            	/*
	            	 * if(listview.getlasvisibleItem()==totalItemCount)
	            	 * */
	            }
	...
	class loadAsyncTask extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String unused) 
		{
			load.setVisibility(View.GONE);
			if(loadcounter==0){
				mCustomTabListAdapter = new CustomTabListAdapter(FreeActivity.this, TopItemList);
				mFreeListViewItem.setAdapter(mCustomTabListAdapter);
				
			}else{
				
				mFreeListViewItem.setSelection(pos);
				mCustomTabListAdapter = new CustomTabListAdapter(FreeActivity.this, TopItemList);
